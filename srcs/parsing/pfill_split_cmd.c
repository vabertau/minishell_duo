...
/*   Updated: 2024/05/06 16:30:26 by vabertau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
Goes through all the tokens, if token is part of a command (token is a word and previous token is
not a redir), increments j which is the number of char * to malloc.

When finding a pipe, end of the command, malloc split_cmd sizeof(char *) * (j + 1)
